            ...
            <div className="WorkWithUsContainer">
                ...
                <div className="WorkWithUsDiv">
                    ...
                    <div className="WorkWithUsDivTexto2">
                        ...
                        <p>We are looking for a Web Application Developer with demonstrable experience developing web applications, preferably in e-commerce or related business environments. You must have a solid understanding of web programming languages ​​such as HTML, CSS, and JavaScript, as well as experience developing responsive and mobile-friendly websites. In addition, you need to have knowledge of databases and experience implementing data storage solutions. Being familiar with popular frameworks and libraries like React, Angular or Vue.js is valued. You must have the ability to work independently and in a team, demonstrating problem-solving skills, and have excellent verbal and written communication skills. Join our team and contribute to the technological growth of our cafeteria!</p>
